...
import (
	...
	"github.com/hashicorp/packer-plugin-googlecompute/builder/googlecomputemachineimage"
...
func main() {
	...
	pps.RegisterBuilder("machineimage", new(googlecomputemachineimage.Builder))
