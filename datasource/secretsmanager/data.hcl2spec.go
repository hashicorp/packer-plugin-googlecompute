...
type FlatConfig struct {
	...
	CredentialsFile *string  `mapstructure:"credentials_file" cty:"credentials_file" hcl:"credentials_file"`
	Endpoint        *string  `mapstructure:"endpoint" cty:"endpoint" hcl:"endpoint"`
	Scopes          []string `mapstructure:"scopes" cty:"scopes" hcl:"scopes"`
	Audience        *string  `mapstructure:"audience" cty:"audience" hcl:"audience"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"audience":         &hcldec.AttrSpec{Name: "audience", Type: cty.String, Required: false},
	}
	return s
}
