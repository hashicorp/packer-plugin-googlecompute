...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_key_exchange_key":          &hcldec.AttrSpec{Name: "image_key_exchange_key", Type: cty.String, Required: false},
		"image_forbidden_signatures_db":   &hcldec.AttrSpec{Name: "image_forbidden_signatures_db", Type: cty.String, Required: false},
