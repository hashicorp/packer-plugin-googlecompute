...
type FlatConfig struct {
	...
	InstanceMaxRunDurationSeconds *int64                            `mapstructure:"instance_max_run_duration_seconds" required:"false" cty:"instance_max_run_duration_seconds" hcl:"instance_max_run_duration_seconds"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"instance_max_run_duration_seconds": &hcldec.AttrSpec{Name: "instance_max_run_duration_seconds", Type: cty.Number, Required: false},
