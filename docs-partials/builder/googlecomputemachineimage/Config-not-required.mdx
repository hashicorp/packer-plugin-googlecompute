<!-- Code generated from the comments of the Config struct in builder/googlecomputemachineimage/config.go; DO NOT EDIT MANUALLY -->
...
- `instance_name` (string) - Skip creating the image. Useful for setting to `true` during a build test stage. Defaults to `false`.
...
- `node_affinity` ([]common.NodeAffinity) - If true, launch a preemptible instance.
...
<!-- End of code generated from the comments of the Config struct in builder/googlecomputemachineimage/config.go; -->
